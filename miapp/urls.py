...
urlpatterns = [
    ...
    path('tributarios/<int:contribuyente_id>/clasificaciones/cargar_masivo/', views.cargar_clasificaciones_masivo, name='cargar_masivo'),
    # Eventos-Pulsar
    ...
    path('api/chartdata/', views.api_chart_data, name='api_chart_data'),
