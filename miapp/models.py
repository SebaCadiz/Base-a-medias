...
class Usuario(models.Model):
    ...
    # ✅ CORRECCIÓN 1: Aumentar max_length para mail a 255.
    # 25 caracteres es muy corto para un correo electrónico moderno.
    mail = models.CharField(max_length=255) 
    # ✅ CORRECCIÓN 2: Aumentar max_length para contraseña a 128.
    # El hash de contraseña de Django (pbkdf2_sha256) es de aproximadamente 128 caracteres.
